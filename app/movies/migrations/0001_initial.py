# Generated by Django 3.2 on 2022-07-25 21:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('film_work', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='person_filmwork', to='movies.filmwork', verbose_name='movie')),
        ...
        migrations.AddIndex(
            ...
            index=psqlextra.indexes.unique_index.UniqueIndex(fields=['film_work_id', 'person_id', 'role'], name='film_work_person_idx'),
        ),
        migrations.AddIndex(
